...
*** WHAT IS A FRAMEWORK?
	- Frameworks are basically commonly used, and proven approach of creating file and folder structure, creating smart logic (implementing
	design patterns, utilities) to be able to easily handle and maintain our project
...
- Basically they want to hear how did you create and structured your project, and what did you use in it to make it functional, reusable, scalable etc.
...
- WHAT IS BDD?
	...
	- BDD is an extension of TDD.
		- What does it mean?
		- It means that the overall implementation flow is very VERY similar.
...
- HOW IS BDD IS SIMILAR TO TDD?
	...
	- We implement in a similar way in the TDD to turn the Scenarios into actions (using JAVA+SELENIUM+JUNIT)
...
- WHAT ARE THE 2 LAYERS OF BDD?
	...
	#2 - IMPLEMENTATION LAYER
		...
		- We are using the preferred programming language and other tools to implement the scenario that are written in the feature files.
...
- WHAT IS A SNIPPET?
	...
	- Basically unimplemented step definition methods that are automatically generated by cucumber for us to implement.
...
-----------------------------------------------------------------------------------------------------------
		...
		*** BDD IMPLEMENTATION TEMPLATE ***  (important)
...
- Cucumber Expressions (Parameterization) is being able to pass test data from the feature files.

- Using Cucumber Expressions, we can pass String, int, float, {word}, and even create our own object types
 to be able to pass from the feature file as test data.
...
- Also we can create our own Object types to be able to pass from feature files
...
- Since we are using WebDriver/ChromeDriver object, to be able to use the methods that are coming from TakesScreenShot interface,
  we have to cast our object type to TakesScreenShot.

- After that we will be able to use the method named ".getScreenshotAs()"

- We also have a class called Scenario, coming from cucumber.io library.

- This Scenario class' object is keeping track of some of time simple data about the scenario that is
  currently being executed, such as;
...
#2- arg2 --> image type --> "image/png" #3- arg3 --> String scenarioName --> scenario.getName()=============================================================
